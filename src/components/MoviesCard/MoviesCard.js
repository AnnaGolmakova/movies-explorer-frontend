    ...
    return (
        <li className="movies-card">
            ...
            <div className="movies-card__details">
                ...
                {!showDelete ?
                    <button type="button" className="like-button" aria-label='Лайк' onClick={() => onLike(Object.assign(movie, { image: image, thumbnail: 'https://api.nomoreparties.co' + movie.image.formats.thumbnail.url }))}>
